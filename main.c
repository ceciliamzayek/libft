...
*/
	...
	write(1, "\n", 1);
	// src = "Pouet!";
	// ft_putstr("   memccpy(&dst_03[17], src, \'\\0\', 12)    : ");
	// src = memccpy(&dst_03[17], src, '\0', 12);
	// ft_putstr("dst_03 = ");
	// ft_putstr(dst_03);
	// write(1, "    ", 4);
	// ft_putstr("src = ");
	...
	// write(1, "\n", 1);
	// src = "Pouet!";
	// ft_putstr("ft_memccpy(&ft_dst_03[17], src, \'\\0\', 12) : ");
	// src = ft_memccpy(&ft_dst_03[17], src, '\0', 12);
	// ft_putstr("dst_03 = ");
	// ft_putstr(ft_dst_03);
	// write(1, "    ", 4);
	// ft_putstr("src = ");
...
*/
	...
	write(1, "\n", 1);
	dst_11[5] = '\0';
	// ft_putstr("   strlcat(dst_11, src, 42) : ");
	// ft_putnbr(strlcat(dst_11, src, 42));
	// ft_putstr("   dst_11 = ");
	// ft_putstr(dst_11);
	// write(1, "\n", 1);
	// ft_dst_11[5] = '\0';
	// ft_putstr("ft_strlcat(dst_11, src, 42) : ");
	// ft_putnbr(ft_strlcat(ft_dst_11, src, 42));
	// ft_putstr("   dst_11 = ");
	// ft_putstr(ft_dst_11);
	write(1, "\n", 1);
	write(1, "\n", 1);
